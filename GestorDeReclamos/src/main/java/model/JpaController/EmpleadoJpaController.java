...
public class EmpleadoJpaController implements Serializable {
    ...
    public void create(Empleado empleado) {
        ...
        try {
            ...
            em.persist(empleado);
            if (empresa != null) {
                empresa.getListaDeEmpleados().add(empleado);
    ...
    public void edit(Empleado empleado) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (empresaOld != null && !empresaOld.equals(empresaNew)) {
                empresaOld.getListaDeEmpleados().remove(empleado);
                empresaOld = em.merge(empresaOld);
            }
            if (empresaNew != null && !empresaNew.equals(empresaOld)) {
                empresaNew.getListaDeEmpleados().add(empleado);
    ...
    public void destroy(Long id) throws NonexistentEntityException {
        ...
        try {
            ...
            Empresa empresa = empleado.getEmpresa();
            if (empresa != null) {
                empresa.getListaDeEmpleados().remove(empleado);
                empresa = em.merge(empresa);
            }
            em.remove(empleado);
            em.getTransaction().commit();
